...
object Model {
  ...
  val models = List(Model("Airbus A220-100","Airbus A220",133,425,828,5741,80000000,1820,8,Manufacturer("Airbus",countryCode = "CA"),1463, imageUrl = "https://www.norebbo.com/2016/02/bombardier-cs100-blank-illustration-templates/"),
...
Model("ATR 42-600","ATR-Regional",48,76,556,1326,17000000,1040,0,Manufacturer("ATR",countryCode = "FR"),1050),
Model("ATR 42-600S","ATR-Regional",48,76,556,1308,19000000,1040,0,Manufacturer("ATR",countryCode = "FR"),750),
