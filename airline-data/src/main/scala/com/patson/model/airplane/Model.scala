...
object Model {
  ...
  val models = List(Model("Cessna 421", "Cessna", capacity = 7, fuelBurn = (7 * 1).toInt, speed = 300, range = 1555, price = 550000, lifespan = 35 * 52, constructionTime = 0, Manufacturer("Cessna", countryCode = "US"), runwayRequirement = 708),
    ...
    Model("Yakovlev Yak-40", "Yakovlev", capacity = 32, fuelBurn = (32 * 3.1).toInt, speed = 550, range = 1800, price = 6000000, lifespan = 25 * 52, constructionTime = 0, Manufacturer("Yakovlev", countryCode = "RU"), runwayRequirement = 978),
    ...
    Model("Tupolev Tu-134", "Tupolev Tu", capacity = 84, fuelBurn = (84 * 4).toInt, speed = 850, range = 3000, price = 31_000_000, lifespan = 25 * 52, constructionTime = 4, Manufacturer("Tupolev", countryCode = "RU"), runwayRequirement = 1400),
    ...
    Model("Boeing 737-100", "Boeing 737", capacity = 124, fuelBurn = (124 * 4).toInt, speed = 780, range = 3440, price = 40000000, lifespan = 35 * 52, constructionTime = 8, Manufacturer("Boeing", countryCode = "US"), runwayRequirement = 1800, imageUrl = "https://www.norebbo.com/2018/10/boeing-737-100-blank-illustration-templates/"),
    ...
    Model("Boeing 737-200", "Boeing 737", capacity = 136, fuelBurn = (136 * 4.3).toInt, speed = 780, range = 4200, price = 59000000, lifespan = 35 * 52, constructionTime = 12, Manufacturer("Boeing", countryCode = "US"), runwayRequirement = 1859, imageUrl = "https://www.norebbo.com/2018/09/boeing-737-200-blank-illustration-templates/"),
    Model("Boeing 737-500", "Boeing 737", capacity = 140, fuelBurn = (140 * 4.1).toInt, speed = 800, range = 5200, price = 80000000, lifespan = 35 * 52, constructionTime = 12, Manufacturer("Boeing", countryCode = "US"), runwayRequirement = 1830, imageUrl = "https://www.norebbo.com/2018/09/boeing-737-500-blank-illustration-templates-with-and-without-blended-winglets/"),
    Model("Boeing 737-700C", "Boeing 737", capacity = 140, fuelBurn = (140 * 3.3).toInt, speed = 825, range = 6083, price = 85000000, lifespan = 35 * 52, constructionTime = 12, Manufacturer("Boeing", countryCode = "US"), runwayRequirement = 2042, imageUrl = "https://www.norebbo.com/2014/04/boeing-737-700-blank-illustration-templates/"),
    ...
    Model("Boeing 737-300", "Boeing 737", capacity = 149, fuelBurn = (149 * 4.1).toInt, speed = 800, range = 4400, price = 75000000, lifespan = 35 * 52, constructionTime = 16, Manufacturer("Boeing", countryCode = "US"), runwayRequirement = 1940, imageUrl = "https://www.norebbo.com/2018/09/boeing-737-300-blank-illustration-templates/"),
    Model("Boeing 737-600", "Boeing 737", capacity = 149, fuelBurn = (149 * 3.9).toInt, speed = 830, range = 7200, price = 82500000, lifespan = 35 * 52, constructionTime = 16, Manufacturer("Boeing", countryCode = "US"), runwayRequirement = 1878, imageUrl = "https://www.norebbo.com/2018/09/boeing-737-600-blank-illustration-templates/"),
    Model("Boeing 737-700", "Boeing 737", capacity = 149, fuelBurn = (149 * 3.8).toInt, speed = 830, range = 7630, price = 85000000, lifespan = 35 * 52, constructionTime = 16, Manufacturer("Boeing", countryCode = "US"), runwayRequirement = 2042, imageUrl = "https://www.norebbo.com/2014/04/boeing-737-700-blank-illustration-templates/"),
    Model("Boeing 737-700ER", "Boeing 737", capacity = 149, fuelBurn = (149 * 4.2).toInt, speed = 830, range = 10200, price = 90000000, lifespan = 35 * 52, constructionTime = 16, Manufacturer("Boeing", countryCode = "US"), runwayRequirement = 2042, imageUrl = "https://www.norebbo.com/2014/04/boeing-737-700-blank-illustration-templates/"),
    ...
    Model("Boeing 737 MAX 7", "Boeing 737", capacity = 172, fuelBurn = (172 * 3.6).toInt, speed = 830, range = 6500, price = 105000000, lifespan = 35 * 52, constructionTime = 20, Manufacturer("Boeing", countryCode = "US"), runwayRequirement = 2100, imageUrl = "https://www.norebbo.com/2016/07/boeing-737-max-7-blank-illustration-templates/"),
    ...
    Model("Boeing 737-800", "Boeing 737", capacity = 184, fuelBurn = (184 * 3.8).toInt, speed = 825, range = 5436, price = 100000000, lifespan = 35 * 52, constructionTime = 24, Manufacturer("Boeing", countryCode = "US"), runwayRequirement = 2316, imageUrl = "https://www.norebbo.com/2012/11/boeing-737-800-blank-illustration-templates/"),
    Model("Boeing 737-400", "Boeing 737", capacity = 188, fuelBurn = (188 * 4.1).toInt, speed = 800, range = 5000, price = 90000000, lifespan = 35 * 52, constructionTime = 24, Manufacturer("Boeing", countryCode = "US"), runwayRequirement = 2540, imageUrl = "https://www.norebbo.com/2018/09/boeing-737-400-blank-illustration-templates/"),
    ...
    Model("Boeing 737-900", "Boeing 737", capacity = 189, fuelBurn = (189 * 4).toInt, speed = 830, range = 6660, price = 105000000, lifespan = 35 * 52, constructionTime = 24, Manufacturer("Boeing", countryCode = "US"), runwayRequirement = 3000, imageUrl = "https://www.norebbo.com/2014/08/boeing-737-900-blank-illustration-templates/"),
    Model("Boeing 737 MAX 8", "Boeing 737", capacity = 189, fuelBurn = (189 * 3.9).toInt, speed = 830, range = 6500, price = 110000000, lifespan = 35 * 52, constructionTime = 24, Manufacturer("Boeing", countryCode = "US"), runwayRequirement = 2500, imageUrl = "https://www.norebbo.com/2016/07/boeing-737-max-8-blank-illustration-templates/"),
    ...
    Model("Boeing 737-900ER", "Boeing 737", capacity = 220, fuelBurn = (220 * 4).toInt, speed = 830, range = 6500, price = 110000000, lifespan = 35 * 52, constructionTime = 24, Manufacturer("Boeing", countryCode = "US"), runwayRequirement = 3000, imageUrl = "https://www.norebbo.com/2016/07/boeing-737-900er-with-split-scimitar-winglets-blank-illustration-templates/"),
    Model("Boeing 737 MAX 9", "Boeing 737", capacity = 220, fuelBurn = (220 * 3.9).toInt, speed = 839, range = 6570, price = 124000000, lifespan = 35 * 52, constructionTime = 36, Manufacturer("Boeing", countryCode = "US"), runwayRequirement = 2600, imageUrl = "https://www.norebbo.com/2018/05/boeing-737-9-max-blank-illustration-templates/"),
    Model("Boeing 737 MAX 10", "Boeing 737", capacity = 230, fuelBurn = (230 * 3.9).toInt, speed = 830, range = 6500, price = 132000000, lifespan = 35 * 52, constructionTime = 36, Manufacturer("Boeing", countryCode = "US"), runwayRequirement = 2700, imageUrl = "https://www.norebbo.com/2019/01/737-10-max-side-view/"),
